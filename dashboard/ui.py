...
async function dw(){try{const r=await api('/api/world/download-url','POST'); const w=window.open(r.url,'_blank','noopener,noreferrer'); if(w){w.opener=null;}}catch(e){st('wstat',e.message,false)}}
